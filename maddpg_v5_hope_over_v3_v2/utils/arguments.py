...
def get_args():
    ...
    parser.add_argument("--max-episode-len", type=int, default=30, help="maximum episode length (steps)")
    parser.add_argument("--total-episodes", type=int, default=50000, help="total episode")
